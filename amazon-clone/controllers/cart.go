...
func GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := UserCollection.FindOne(ctx, bson.D{primitive.E{Key: "id", Value: usert_id}}).Decode(&filledcart)
...
func (app *Application) BuyFromCart() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		errr := database.BuyItemFromCart(ctx, app.userCollection, userQueryID)

		if errr != nil {
			c.IndentedJSON(http.StatusInternalServerError, err)
		}

		c.IndentedJSON(200, "successfully created the order!")
	}
